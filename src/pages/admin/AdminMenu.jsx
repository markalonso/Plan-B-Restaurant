...
const AdminMenu = () => {
  ...
  return (
    <AdminLayout>
      <div>
        <h1 className="text-3xl font-semibold text-neutral-slate">Menu</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <form className="glass-card space-y-3" onSubmit={handleItemSubmit}>
          <h2 className="text-lg font-semibold text-neutral-slate">Add item</h2>
          <input
            type="text"
          ...
          <div className="flex flex-wrap gap-4 text-sm text-neutral-slate/70">
      ...
      <div className="glass-card space-y-4">
        <h2 className="text-lg font-semibold text-neutral-slate">Menu items</h2>
        {items.map((item) => (
          <div
            key={item.id}
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-neutral-slate/60">EGP {item.price}</p>
              </div>
              <button
                type="button"
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              <input
                ...
                className="w-full rounded-lg border border-accent-sand/40 px-3 py-2 text-xs"
              />
              <div className="flex flex-wrap gap-4 text-xs text-neutral-slate/70">
                <label className="flex items-center gap-2">
                  <input
                    type="checkbox"
      ...
      <div className="glass-card space-y-3">
        <h2 className="text-lg font-semibold text-neutral-slate">Categories</h2>
        {categories.map((category) => (
          <div
            key={category.id}
          ...
          >
            <div className="grid gap-2 md:grid-cols-2">
              <input
                ...
                className="rounded-lg border border-accent-sand/40 px-3 py-2 text-xs"
              />
              <input
                type="number"
