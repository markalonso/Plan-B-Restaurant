...
const AdminEvents = () => {
  ...
  return (
    <AdminLayout>
      <div>
        <h1 className="text-3xl font-semibold text-text-primary">Event Requests</h1>
      ...
      <div className="glass-card overflow-hidden">
        {loading ? (
          <p className="text-sm text-text-muted">Loading event requests…</p>
        ) : (
              ...
              {filteredRequests.map((request) => (
                <tr key={request.id}>
                  <td className="py-4">
                    ...
                    <p className="text-text-muted">{request.phone}</p>
                  </td>
          ...
          <div className="glass-card max-w-lg">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-text-muted">ID: {activeRequest.id}</p>
              </div>
              <button
                type="button"
